...
function taskSass() {
  return src(srcDir + '/sass/**/*.{sass,scss}')
...
function taskStartwatch() {
  watch(srcDir + '/sass/**/*.{sass,scss}', { usePolling: true }, taskSass);
...
exports.default = series(taskSass, taskJs, taskImg, parallel(taskBrowsersync, taskStartwatch));